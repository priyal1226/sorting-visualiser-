...
function dis()
{
  ...
  document.getElementById("button1").style.backgroundColor = "rgb(214, 209, 209);"
  document.getElementById("button2").disabled = "true";
  document.getElementById("button2").style.backgroundColor = "rgb(214, 209, 209);"
  document.getElementById("button5").disabled = "true";
  document.getElementById("button5").style.backgroundColor = "rgb(214, 209, 209);"
  document.getElementById("button3").disabled = "true";
  document.getElementById("button3").style.backgroundColor = "rgb(214, 209, 209);"
}